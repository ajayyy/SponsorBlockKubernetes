...
module "kube-hetzner" {
  ...
  extra_firewall_rules = [
    ...
    {
      description     = "For postgres outgoing"
      direction       = "out"
      protocol        = "tcp"
      port            = "5432"
      source_ips      = [] # Won't be used for this rule
  ...
  # This is the official link which is the fastest but most of the time gives 403.
  ...
  # This one is usually slow but never has any problems.
  ...
  rancher_hostname = "rancher.sponsor.ajay.app"
